...
import { usePlayTrailer, useRouter, useState } from "@/shared/hooks";
import {
  MainBtn,
  NoResultsFound,
  RatingStars,
...
const MoviesHeroSlider = ({ movies, isTvShow = false }) => {
  ...
  const { trailesrModal, getTrailers } = usePlayTrailer();
